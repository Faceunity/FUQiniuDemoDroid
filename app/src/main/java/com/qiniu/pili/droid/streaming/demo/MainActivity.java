...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvRoomId = (TextView) findViewById(R.id.et_room_id);
...
//        mInputTextTV.setText(Cache.retrieveURL(this));
        mInputTextTV.setText("rtmp://pili-publish.xuzhuolalala.support2technical.me/xuzhuo-lalala/qiniu_test");
    ...
    public void launchStreaming(View v) {
        ...
        String roomId = mTvRoomId.getText().toString().trim();
        streamText = streamText + "-" +roomId;
    ...
    public void onClickGenPublishURL(View v) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.e(TAG, "run: publishUrl " + publishUrl);
                if (publishUrl != null) {
